 ...
 begin  
   ...
   FIR_int : FIR_RI  
     ...
     -- Writing output result to output file 
           ...
           begin  
          file_open(v_estado_input, file_input, "C:\INFORMATICA\4_CURSO\TFG\Codigo\FIR_FILTER_MATLAB\Inputs\input100.txt", read_mode);
         file_open(v_estado_input, file_output, "../../../../output101_functional_sim.txt", write_mode);
  ...
  assert v_estado_output = open_ok
    ...
    severity failure;
                if reset ='1' then  
                     ...
                     readline(file_input, my_input_line);  
