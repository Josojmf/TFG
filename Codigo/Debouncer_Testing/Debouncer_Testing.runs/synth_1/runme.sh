...
HD_PWD='C:/INFORMATICA/4_CURSO/TFG/Codigo/Debouncer_Testing/Debouncer_Testing.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Debouncing_Button_VHDL.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Debouncing_Button_VHDL.tcl
